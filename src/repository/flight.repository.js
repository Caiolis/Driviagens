...
async function findAllFlightsIntoDb(origin, destination, smallerDate, biggerDate) {
    const array = []
    let query = `
...
export const flightRepository = { insertFlightIntoDb, findAllFlightsIntoDb, findById }